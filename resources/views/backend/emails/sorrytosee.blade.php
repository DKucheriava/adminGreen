                                                ...
                                                <tr>
                                                    <td>
                                                       <!--  <h4 style="margin-bottom:0;color: #525252;"> Dear {{ $name }} </h4> -->
                                                        ...
                                                        <p style="padding: 9px 30px 20px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;text-align: left;">Dear {{ $name }} <br>
                                                            <!-- <br> Welcome to Green Pheasants! -->
                                                            <br>We have deleted your account, please feel welcome to register again in the future.<br><br>
                                                            Wishing you a nice day and poetic moments,<br>
