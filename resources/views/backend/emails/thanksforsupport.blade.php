                                                ...
                                                <tr>
                                                    <td>
                                                       <!--  <h4 style="margin-bottom:0;color: #525252;"> Dear {{ $name }} </h4> -->
                                                        ...
                                                        <p style="padding: 9px 30px 20px; line-height:22px; font-size:14px; color: #505050; letter-spacing: 1px; margin: 0;text-align: left;">Dear {{ $name }} <br><br> Thank you for supporting us and invoice! <br><br>Kind regards,<br>
